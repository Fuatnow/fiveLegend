...
public class OverLayer : MonoBehaviour {
	...
	public void downFromeTop()
	{
		...
		var audioBtn_on = gameObject.transform.Find ("overBg/audioBtn_on").gameObject;
		var audioBtn_off =  gameObject.transform.Find ("overBg/audioBtn_off").gameObject;
		audioBtn_on.SetActive (canPlay);
		audioBtn_off.SetActive (!canPlay);
		
		var pauseBg = gameObject.transform.Find ("overBg").gameObject;
