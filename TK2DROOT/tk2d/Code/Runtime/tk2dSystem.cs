...
public class tk2dSystem : ScriptableObject
{
	...
	public tk2dAssetPlatform[] assetPlatforms = new tk2dAssetPlatform[] {
		...
		//i change it 2.0 - to 1.0
//		new tk2dAssetPlatform("2x", 2.0f),
		new tk2dAssetPlatform("2x", 1.0f),
...
#region platforms
	...
	static string currentPlatform = initCurrentPlatform(); // Not serialized, this should be s
	...
	static string initCurrentPlatform()
	{
		var platform = "2x";
